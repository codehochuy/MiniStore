        ...
        <main class="app-content">
            <div class="app-title"> 
                <ul class="app-breadcrumb breadcrumb side">
                 ...
                 <li class="breadcrumb-item"><a href="#">Thay đổi nhân viên thứ nhất</a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                    ...
                    <div class="tile">
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    <form action="WorkSheet_delete" method="GET">
                                   
                                    <button class="btn btn-primary btn-sm trash" title="" type = "submit"><i class="fas fa-trash-alt"></i>
                                        Xoá nhân viên thứ nhất ra khỏi ca </button>
                                        <input type="hidden" name="shiftid" value="${requestScope.shiftid}" />
                                         <input type="hidden" name="employeeidfirst" value="${requestScope.employeeidfirst}" />
                                         </form>
...
<!--                                                <td width="10"><input type="checkbox" name="check1" value="1"></td>-->
    ...
    <form style="width: 40px;" action="WorkSheet_change_add" method="GET">
        
        <button class="btn btn-primary btn-sm edit" type="submit" title="Chọn nhân viên này" name="employeeid" value="${i.employeeID}">
