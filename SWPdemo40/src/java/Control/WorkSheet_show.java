 ...
 * @author Vuong
 */
public class WorkSheet_show extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet WorkSheetServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet WorkSheetServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
// Xoá Session có tên "LISTSHIFTID" (nếu có)
//    HttpSession session = request.getSession();
//    session.removeAttribute("LISTSHIFTID");
