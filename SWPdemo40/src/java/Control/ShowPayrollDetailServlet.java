 ...
 * @author DELL
 */
@WebServlet(name = "ShowPayrollDetailServlet", urlPatterns = {"/ShowPayrollDetailServlet"})
public class ShowPayrollDetailServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("ShowPayrollDetail.jsp").forward(request, response);
        }
    }
